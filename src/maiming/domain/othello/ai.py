# FILE: src/maiming/domain/othello/ai.py
...
from .types import OTHELLO_DIFFICULTY_MEDIUM, OTHELLO_DIFFICULTY_STRONG, OTHELLO_DIFFICULTY_WEAK, SIDE_BLACK, SIDE_WHITE, normalize_difficulty, normalize_side
