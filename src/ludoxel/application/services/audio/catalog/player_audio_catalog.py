...
PLAYER_EVENT_SOUND_CATALOG: dict[str, AudioSamplePool] = {
    ...
    PLAYER_EVENT_OTHELLO_PLACE: make_audio_pool(
        *indexed_paths("assets/audio/player/othello/place", "place", 2),
        category=AUDIO_CATEGORY_PLAYER,
        max_polyphony=3,
    ),
    PLAYER_EVENT_OTHELLO_FLIP: make_audio_pool(
        *indexed_paths("assets/audio/player/othello/flip", "flip", 2),
        category=AUDIO_CATEGORY_PLAYER,
