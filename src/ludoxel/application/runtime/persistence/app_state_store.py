...
class AppStateStore:
    ...
    def save(self, state: AppState) -> None:
        player_file = PlayerStateFile(version=6, current_space_id=state.current_space_id, settings=state.settings, inventory=state.inventory, othello_settings=state.othello_settings.normalized())
