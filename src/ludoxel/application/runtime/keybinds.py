...
CONTROL_SECTION_GAMEPLAY: tuple[str, ...] = (ACTION_TOGGLE_INVENTORY, ACTION_TOGGLE_CREATIVE_MODE, ACTION_CYCLE_CAMERA_PERSPECTIVE, ACTION_TOGGLE_GAMEPLAY_HUD, ACTION_CLEAR_SELECTED_SLOT, ACTION_TOGGLE_DEBUG_HUD, ACTION_TOGGLE_DEBUG_SHADOW)

DEFAULT_KEYBINDS: dict[str, str] = {ACTION_MOVE_FORWARD: "W", ACTION_MOVE_BACKWARD: "S", ACTION_MOVE_LEFT: "A", ACTION_MOVE_RIGHT: "D", ACTION_JUMP: "Space", ACTION_CROUCH: "Shift", ACTION_SPRINT: "Control", ACTION_TOGGLE_INVENTORY: "E", ACTION_TOGGLE_CREATIVE_MODE: "B", ACTION_CYCLE_CAMERA_PERSPECTIVE: "F5", ACTION_TOGGLE_GAMEPLAY_HUD: "F1", ACTION_TOGGLE_DEBUG_HUD: "F3", ACTION_TOGGLE_DEBUG_SHADOW: "F4", ACTION_CLEAR_SELECTED_SLOT: "Q"}
for _index, _action in enumerate(HOTBAR_ACTIONS, start=1):
