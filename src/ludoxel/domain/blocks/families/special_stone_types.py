...
SPECIAL_STONE_TYPES: tuple[StoneType, ...] = (
    ...
    StoneType(key="netherite_block", display="Block of Netherite", textures=cube_textures("netherite_block"), sound_group="metal"),
    ...
    StoneType(key="dark_prismarine", display="Dark Prismarine", textures=cube_textures("prismarine_dark"), slab_key="dark_prismarine_slab", stairs_key="dark_prismarine_stairs", sound_group="prismarine"),
    StoneType(key="prismarine_bricks", display="Prismarine Bricks", textures=cube_textures("prismarine_bricks"), slab_key="prismarine_brick_slab", stairs_key="prismarine_brick_stairs", sound_group="prismarine"),
    StoneType(key="prismarine", display="Prismarine", textures=cube_textures("prismarine_rough_01"), slab_key="prismarine_slab", stairs_key="prismarine_stairs", sound_group="prismarine"),
    ...
    StoneType(key="iron_block", display="Block of Iron", textures=cube_textures("iron_block"), sound_group="metal"),
    StoneType(key="coal_block", display="Block of Coal", textures=cube_textures("coal_block")),
    StoneType(key="gold_block", display="Block of Gold", textures=cube_textures("gold_block"), sound_group="metal"),
    ...
    StoneType(key="magma_block", display="Magma Block", textures=cube_textures("magma_01"), sound_group="magma"),
