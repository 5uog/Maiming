# FILE: presentation/widgets/deathOverlay.py
...
class DeathOverlay(QWidget):
    ...
    def __init__(self, parent: QWidget | None = None) -> None:
        ...
        self.setStyleSheet(
            "QWidget#deathRoot { background: rgba(0,0,0,170); }"
            "QFrame#panel { background: rgba(32,34,37,245); border: 1px solid rgba(255,255,255,55); border-radius: 10px; }"
            "QLabel { color: white; font: 13px; }"
            "QLabel#title { font: 22px; font-weight: 800; }"
            "QPushButton { color: white; background: rgba(70,70,70,220); border: 1px solid rgba(255,255,255,60); padding: 10px 12px; border-radius: 8px; }"
            "QPushButton:hover { background: rgba(90,90,90,235); }"
        )
